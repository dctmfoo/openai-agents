...
- Vision turns disable all tools (`web_search_call`, `read_scoped_memory`, `remember_daily`, `semantic_search`, `file_search`) so image analysis stays direct model vision and avoids tool-loop latency.
